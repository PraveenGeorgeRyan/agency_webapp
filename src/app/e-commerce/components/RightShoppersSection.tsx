...
const RightShoppersSection = () => (
    <section className="py-16">
        <div className="container px-12 mx-auto">
            <h2 className="md:text-center text-3xl md:text-4xl font-bold text-gray-800 pb-2">Reach the right shoppers with the right products</h2>
            <p className="lg:w-[85%] w-full mx-auto mb-8 font-light md:text-center text-gray-600">Sell products to the shoppers who matter most–the ones looking for what you offer, <br className="hidden xl:block" /> whether they're at home, on the go, or in-store.</p>
        </div>
