    ...
    const reviews = [
        {
            ...
            quote: "I have been working with SearchKings for over 5 years now and am happy with our results. Being able to quantify the return on investment is key. Their services are flexible to our changing needs and our account manager is attentive. Thanks for the g...",
            name: "Renee Taylor",
        ...
        },
        {
            ...
            quote: "Since we joined the SearchKings team our revenue has increased 70%. Best business decision we ever made. Their personal attention and advice made all the difference. Yaz, is our account manager and is always available to answer questions and give a...",
            name: "Joseph Dittmar",
            company: "Coastal Climate Experts LLC"
        },
        {
            logo: 'https://cdn.searchkings.ca/img/testimonials/adaptive-ae6c6295f8.webp',
            quote: "Working with SearchKings has been a dream. SearchKings breaks down my monthly spend with in depth reports and meetings monthly to go over how to most effectively capture leads and with their help our spend has led to conversions to actual clients.",
            name: "Ian Sutherland",
            ...
            <div className="container mx-auto flex items-center flex-col">
                <div className="text-center px-4 mb-8">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        At SearchKings, we take pride in the relationships we have with our customers.
                        ...
                        {extendedReviews.map((review, index) => (
                            ...
                            >
                                ...
                                <div className="flex items-center text-yellow-500">
                                    ...
                                    <span className="ml-2 text-gray-800">5.0</span>
                                </div>
                                <div>
