...
const JobPostings = () => {
  const torontoJobs = [
    {
      ...
      description: "We are seeking a talented individual to join our team as a Senior Google Advertising Account Manager.",
      requirements: [
    ...
    return (
      <li className="relative bg-bgGray rounded-xl">
        <button 
          ...
          onClick={() => {
            const container = document.querySelector(`[data-ref="${containerRef}"]`) as HTMLElement;
            if (container) {
        ...
        >
          <div className="flex items-center justify-between">
            <h3 className="px-6 py-6 font-bold text-md md:text-lg pr-12">{job.title}</h3>
        ...
        >
          <div className="px-6 pb-6">
            ...
            {job.workOn && (
              <div className="py-4">
                <p className="font-bold text-base mb-2">What You Will Work On</p>
            ...
            {job.requirements && (
              <div className="py-4">
                <p className="font-bold text-base mb-2">{job.workOn || job.profile ? "Requirements" : "Applicant Requirements"}</p>
                <ul className="checklist">
            ...
            {job.skills && (
              <div className="py-4">
                <p className="font-bold text-base mb-2">{job.profile ? "Skills" : "Qualifications / Skills"}</p>
                <ul className="checklist">
  ...
  return (
    <>
      ...
      <div className="mb-8">
        <p className="lg:text-2xl text-xl font-bold my-4 lg:px-6 px-4 tracking-tighter">Toronto :</p>
      ...
      <div className="mb-8">
        <p className="lg:text-2xl text-xl font-bold my-4 lg:px-6 px-4 tracking-tighter">Vancouver :</p>
        <div className="bg-white">
          <ul className="flex flex-col gap-4 shadow-box">
