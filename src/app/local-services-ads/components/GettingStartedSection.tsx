    ...
    return (
        <section className="py-16">
            <div className="container px-12 mx-auto">
                <h2 className="md:text-center text-3xl md:text-4xl font-bold text-gray-800">Getting started is easy</h2>
                <p className="text-black lg:w-[75%] w-full mx-auto mb-8 font-light md:text-center text-left text-gray-600">As the largest manager of Local Services Ads accounts worldwide, we've helped thousands of businesses register into the program, generate more leads, and grow their company.</p>
            </div>
            <div className="container mx-auto px-12">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {steps.map(step => (
                        <div key={step.title} className="card relative rounded-3xl p-8 shadow-lg overflow-hidden bg-[#32B355] text-white h-full flex flex-col justify-between">
                            <div>
                                {step.icon.includes('.') ?
