...
const HelpingPartnersSection: React.FC = () => (
  <section className="py-16">
    <div className="container px-12 mx-auto lg:text-center">
      <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Helping our partners</h2>
      <p className="mb-8 lg:w-[85%] mx-auto text-gray-600 mt-4">Our goal is to help you grow. We have helped companies of all types and sizes sustainably scale their business by understanding their needs and building strategic digital advertising solutions.</p>
