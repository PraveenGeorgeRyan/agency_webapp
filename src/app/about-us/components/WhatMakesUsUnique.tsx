    ...
    <section className="py-16">
      <div className="container mx-auto px-12">
        <div className="w-full pb-8 lg:text-center text-left">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800">What makes us unique?</h2>
          <p className="text-gray-600 mt-4">We are experts at managing scalable search, remarketing, display and video advertising campaigns.</p>
        </div>
