    ...
    return (
        <section className="py-16">
            <div className="container px-12 mx-auto">
                ...
                <p className="text-black lg:w-[85%] w-full mx-auto mb-8 font-light md:text-center text-left text-gray-600">Our team of video ad experts will harness the power of YouTube advertising to grow your brand and increase awareness. Reach your demographic during their commute, while browsing on their phone, at work, or even while watching TV at home.</p>
            </div>
