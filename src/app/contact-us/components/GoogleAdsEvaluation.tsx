    ...
    <div className="container mx-auto px-12">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div className="relative h-[300px] md:h-[500px] w-full">
          <iframe className="absolute inset-0 w-full h-full rounded-3xl" frameBorder={0} title="map" marginHeight={0} marginWidth={0} scrolling="no" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=(SearchKings)&ie=UTF8&t=&z=14&iwloc=B&output=embed"></iframe>
        </div>
        <div className="bg-[#0075E3] rounded-3xl p-8 text-white">
          ...
          <p>Our belief is that by demonstrating our expertise, you'll be more likely to choose SearchKings as a partner when the time comes to grow your campaign.</p>
          <a href="/account-evaluation/" className="shrink-0 w-max block mt-8 no-underline shadow-xl rounded-full overflow-hidden">
