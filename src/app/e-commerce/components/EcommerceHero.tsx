    ...
    <section className="relative w-full pt-[76px] bg-[#01594d] text-white overflow-hidden">
        <div className="container px-12 xl:pb-0 pb-12 flex items-stretch justify-center min-h-[430px] sm:min-h-[340px] xl:min-h-[600px] relative z-[1] gap-8 py-8 mx-auto">
            <div className="w-full xl:w-1/2 flex flex-col justify-center items-start text-left gap-4 xl:pl-24">
                <h1 className="text-4xl md:text-5xl xl:text-6xl font-bold xl:max-w-3xl">eCommerce Ads</h1>
                <p className="w-full md:w-[80%] xl:w-full font-light xl:my-6">Let SearchKings help your retail business set-up and manage Google & Microsoft Shopping campaigns. We can promote your online products or local inventory, boost traffic to your website or store, and generate more online sales.</p>
            ...
            <div className="items-end justify-center hidden xl:flex xl:w-1/2">
                 <div className="bg-white max-w-[333px] rounded-t-3xl flex flex-col items-center gap-10 py-12 px-4 border-b-[1px] border-slate-200 w-[150%] shadow-lg">
                    <div className="rounded-full w-full bg-[#01594d] flex items-stretch shadow-lg justify-between xl:h-[55px] overflow-hidden z-10">
                        ...
                        <span className="flex items-center text-white text-sm sm:text-base xl:text-xl px-3 sm:pr-5 sm:pl-0">new shoes</span>
                    </div>
                    <div className="bg-white rounded-3xl shadow-lg border lg:shadow-none p-2 flex justify-around gap-[8px] items-end z-10 w-[150%] !shadow-lg">
                        <div className="bg-gray-100 p-5 rounded-2xl text-left">
                            <img src="https://cdn.searchkings.ca/img/ecommerce/shoe-213d417211.webp" width="134" height="88" alt="Low top shoe"/>
                            <div className="text-sm sm:text-lg xl:text-xl text-black mt-2"> Low Top Shoe </div>
                            <small className="block text-[11px] leading-tight text-gray-500">example-business.com</small>
                            <hr className="my-2" />
                            <div className="flex justify-between items-center">
                                <span className="text-xs text-black">$180.00</span>
                                <div className="text-xs flex items-center gap-1 text-gray-600">
                                    <span className="text-[#e37325] flex">
                                        <img src="/images/star.png" alt="star" width="12" height="12" />
                                        <img src="/images/star.png" alt="star" width="12" height="12" />
                                        <img src="/images/star.png" alt="star" width="12" height="12" />
                                        <img src="/images/star.png" alt="star" width="12" height="12" />
                                        <img src="/images/star.png" alt="star" width="12" height="12" />
                        ...
                        <div className="bg-gray-100 p-5 rounded-2xl text-left">
                            <img src="https://cdn.searchkings.ca/img/ecommerce/shoe2-a75a44e38d.webp" width="134" height="88" alt="High top shoe"/>
                            <div className="text-sm sm:text-lg xl:text-xl text-black mt-2"> High Top Shoe </div>
                            <small className="block text-[11px] leading-tight text-gray-500">example-business.com</small>
                            <hr className="my-2" />
                            <div className="flex justify-between items-center">
                                <span className="text-xs text-black">$180.00</span>
