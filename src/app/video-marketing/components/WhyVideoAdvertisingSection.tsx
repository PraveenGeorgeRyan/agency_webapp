...
const WhyVideoAdvertisingSection = () => (
    <section className="py-16">
        <div className="container px-12 mx-auto">
            <h2 className="md:text-center text-3xl md:text-4xl font-bold text-gray-800">Why use video advertising?</h2>
            <p className="text-black lg:w-[85%] w-full mx-auto mb-8 font-light md:text-center text-left text-gray-600">Capture your audience's attention effectively throughout their consumer journey by showcasing your brand in video advertisements, ensuring meaningful engagement during the decision-making process.</p>
