  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-12">
        <div className="flex flex-col lg:flex-row justify-center items-center rounded-3xl shadow-xl bg-[#F8F8F8] p-8">
          <div className="w-full lg:w-1/3 p-0 pb-8 lg:p-12">
          ...
          <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-16 p-0 lg:p-12">
            {steps.map(step => (
              <div key={step.title} className="flex flex-col items-start gap-2">
                ...
                <div className="pt-4">
                  <p className="text-xl lg:text-3xl font-bold mb-2 text-gray-800">{step.title}</p>
