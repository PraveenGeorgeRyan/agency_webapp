...
const ConversionRatesSection = () => (
    <section className="py-16">
        <div className="container px-12 mx-auto">
            <h2 className="md:text-center text-3xl md:text-4xl font-bold text-gray-800">Measure & improve conversion rates</h2>
            <p className="text-black mb-8 font-light md:text-center text-left text-gray-600">Our sites focus on the core aspects of a businesses product or service offering. This allows us <br className="hidden xl:block" /> to focus the customer's attention on calling or filling out a form.</p>
