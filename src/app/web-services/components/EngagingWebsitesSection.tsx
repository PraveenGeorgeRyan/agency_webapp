...
const EngagingWebsitesSection = () => (
    <section className="py-16">
        <div className="container px-12 mx-auto">
            <h2 className="md:text-center text-3xl md:text-4xl font-bold text-gray-800">Engaging websites to drive conversions</h2>
            <p className="text-black lg:w-[85%] w-full mx-auto mb-8 font-light md:text-center text-left text-gray-600">SearchKings creates engaging websites that display the core aspects of your product or service offering.</p>
        </div>
